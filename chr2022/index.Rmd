---
title: "Boosting </br> word frequencies" 
subtitle: "in authorship attribution"
author: Maciej Eder (<a>maciej.eder@ijp.pan.pl</a>)
date: 14.12.2022 
      </br></br></br> CHR2022 conference </br>
...
# gain over the baseline
plot_2 = levelplot(t(performance_gain_eder), cuts = 1000, scales = list(x = x.scale, y = y.scale), col.regions = rev(turbo(1000, end = 0.6)), xlab= "semantic background (cosine distance)", ylab = "MFWs", main = "Eder's Delta", at=seq(0, 0.084, length.out=120))
plot_2
